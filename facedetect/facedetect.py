...
def predict(width, height, confidences, boxes, prob_threshold, iou_threshold=0.3, top_k=-1):
    ...
    :param confidences:
    :param boxes:
    :param prob_threshold:          to filter the network`s output
    :param iou_threshold:
    :param top_k:
    :return: boxes` location shape = (face.nums, 4), label,  probs
    '''
    boxes = boxes[0]
...
parser.add_argument('--onnx_path', default="Automatic_Face_Mosaic/facedetect/version-RFB-320_simplified.onnx", type=str, help='onnx version')
...
parser.add_argument('--imgs_path', default="Automatic_Face_Mosaic/imgs", type=str, help='imgs dir')
parser.add_argument('--results_path', default="Automatic_Face_Mosaic/results", type=str, help='results dir')
